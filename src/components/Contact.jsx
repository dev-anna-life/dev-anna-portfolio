            ...
            <div className="reveal-left bg-dark-card border border-dark-box rounded-3xl p-7">
              ...
              <div className="space-y-5">
                <a href="https://mail.google.com/mail/?view=cm&to=annastesiaugwuanyi@gmail.com"
                  ...
                  <div className="w-10 h-10 rounded-full bg-dark-box flex items-center justify-center text-primary-accent group-hover:bg-primary group-hover:text-white transition-all duration-200">
                    <FaEnvelope />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-dark-box flex items-center justify-center text-primary-accent">
                    <FaGithub />
                  </div>
                  <div>
