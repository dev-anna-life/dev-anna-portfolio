...
import { FaSearch, FaEnvelopeOpenText, FaAd, FaGoogle, FaCog, FaUsers, FaVideo, FaShoppingBag } from 'react-icons/fa'
...
const marketingServices = [
  ...
  { icon: FaShoppingBag, title: 'Shopify & Etsy Setup', text: 'Full store setup and optimization for Shopify and Etsy: themes, listings, SEO, and payment integration.' },
]
